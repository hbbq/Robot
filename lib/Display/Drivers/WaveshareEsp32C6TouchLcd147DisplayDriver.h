...
class WaveshareEsp32C6TouchLcd147DisplayDriver
    : public IDisplayDriver
{
public:
    explicit WaveshareEsp32C6TouchLcd147DisplayDriver(
        uint8_t rotation = 1);
        
    ~WaveshareEsp32C6TouchLcd147DisplayDriver() override;

    WaveshareEsp32C6TouchLcd147DisplayDriver(
        const WaveshareEsp32C6TouchLcd147DisplayDriver&) = delete;

    WaveshareEsp32C6TouchLcd147DisplayDriver& operator=(
        const WaveshareEsp32C6TouchLcd147DisplayDriver&) = delete;
